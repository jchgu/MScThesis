...
```{r v-plot-cog, fig.cap = paste("(ref:cog-dif)", "(ref:migr)"), out.height='40%'}
fig_cog
```

\newpage

```{r v-plot-ttl, fig.cap = paste("(ref:ttl-dif)", "(ref:migr)"), out.height='40%'}
fig_ttl
```

```{r v-plot-cog-1, fig.cap = paste("(ref:cog-dif)", "(ref:migr-type)"), out.height='40%'}
fig_cog_by_migration_type
```

```{r v-plot-ttl-1, fig.cap = paste("(ref:ttl-dif)", "(ref:migr-type)"), out.height='40%'}
