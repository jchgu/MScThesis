...
authornote: | 
  This paper's open science repository: https://github.com/jianchenggu/MScThesis
...
I adopted `R` (version 4.3.0) for all the analyses [@R-base]. This involved the following packages: `tidyverse` (version 2.0.0) and `haven` (version 2.5.2) for data cleaning [@R-tidyverse; @R-haven]; `fixest` (version 0.11.1) for econometric modeling [@R-fixest]; `MatchIt` (version 4.5.3) and `cobalt` (version 4.5.0) for matching [@ho2011; @R-MatchIt; @R-cobalt]; `modelsummary` (version 1.3.0), `vtable` (version 1.4.2), and `kableExtra` (version 1.3.4) for presenting the results [@R-modelsummary; @R-vtable; @R-kableExtra]; and `papaja` (version 0.1.1) for typesetting [@R-papaja].
