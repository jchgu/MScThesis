...
I adopted `R` (version 4.2.2) for all the analyses [@R-base]. This involved the following packages: `tidyverse` (version 2.0.0) and `haven` (version 2.5.0) for data cleaning [@R-tidyverse; @R-haven]; `fixest` (version 0.11.1) for econometric modeling [@berge2018; @R-fixest]; `MatchIt` (version 4.5.1) and `cobalt` (version 4.3.2) for matching [@ho2011; @R-MatchIt; @R-cobalt]; `modelsummary` (version 1.3.0), `vtable` (version 1.4.1), and `kableExtra` (version 1.3.4) for presenting the results [@R-modelsummary; @R-vtable; @R-kableExtra]; and `papaja` (version 0.1.1) for typesetting [@R-papaja].
