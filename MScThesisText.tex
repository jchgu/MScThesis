...
\hypersetup{
  pdftitle={Left-Behind Children's Educational Performance Drops Slightly After Parents Migrated},
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2079}}
  >{\centering\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2178}}
  >{\centering\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2178}}
  >{\centering\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2277}}@{}}
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1880}}
  >{\centering\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1880}}
  >{\centering\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1966}}@{}}
\caption{Parental migration's effect on children's academic exam score}\tabularnewline
\toprule
\begin{minipage}[b]{\linewidth}\raggedright
\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
...
\begin{figure}
\centering
\includegraphics{MScThesisText_files/figure-latex/v-plot-cog-1.pdf}
...
\begin{figure}
\centering
\includegraphics{MScThesisText_files/figure-latex/v-plot-ttl-1.pdf}
...
\begin{figure}
\centering
\includegraphics{MScThesisText_files/figure-latex/v-plot-cog-1-1.pdf}
...
\begin{figure}
\centering
\includegraphics{MScThesisText_files/figure-latex/v-plot-ttl-1-1.pdf}
...
\begin{figure}
\centering
\includegraphics{MScThesisText_files/figure-latex/cobal-any-1.pdf}
...
\begin{figure}
\centering
\includegraphics{MScThesisText_files/figure-latex/cobal-mo-1.pdf}
...
\begin{figure}
\centering
\includegraphics{MScThesisText_files/figure-latex/cobal-fa-1.pdf}
...
\begin{figure}
\centering
\includegraphics{MScThesisText_files/figure-latex/cobal-both-1.pdf}
...
\leavevmode\vadjust pre{\hypertarget{ref-parliamentaryassembly2021a}{}}%
