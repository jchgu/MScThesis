...
The DID model is unrestricted because it does not restrict on the coefficient associated with the baseline scores. The model is unadjusted as it does not adjust for additional covariates. Theoretically, it is unnecessary to include covariates that vary over group but remain constant over time; They would cancel out in the two-way fixed effect model (Huntington-Klein, 2022). The standard errors are clustered at the classroom level.
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1940}}
  >{\centering\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2090}}@{}}
\caption{\label{tab:tab-reg-m-cog}Parental migration's effect on children's cognitive test scores, estimated with matching}\tabularnewline
\toprule
...
\midrule
\endhead
Migration & -2.64*** & -2.76* & -3.41** & -1.96 \\
& (0.74) & (1.22) & (1.25) & (1.74) \\
Baseline.score & -0.70*** & -0.74*** & -0.62*** & -0.69*** \\
& (0.02) & (0.04) & (0.03) & (0.05) \\
Num.Obs. & 2503 & 1032 & 1008 & 515 \\
R2 & 0.392 & 0.450 & 0.423 & 0.467 \\
R2 Adj. & 0.363 & 0.384 & 0.356 & 0.352 \\
FE: schids & X & X & X & X \\
\bottomrule
\end{longtable}
...
\textbf{Note:}
\^{}\^{} 3:1 optimal pair propensity score matching; exact matching by county
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1940}}
  >{\centering\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2090}}@{}}
\caption{\label{tab:tab-reg-m-ttl}Parental migration's effect on children's cognitive test scores, estimated with matching}\tabularnewline
\toprule
\begin{minipage}[b]{\linewidth}\raggedright
\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
Any Parent
...
\midrule
\endhead
Migration & -1.22* & -1.65* & -1.15 & 0.46 \\
& (0.57) & (0.81) & (0.86) & (0.98) \\
Baseline.score & 0.05† & 0.07† & 0.04 & 0.01 \\
& (0.03) & (0.04) & (0.04) & (0.04) \\
Num.Obs. & 2503 & 1032 & 1008 & 515 \\
R2 & 0.468 & 0.587 & 0.480 & 0.501 \\
R2 Adj. & 0.444 & 0.538 & 0.420 & 0.393 \\
FE: schids & X & X & X & X \\
\bottomrule
\end{longtable}
...
Greifer, N. (2022a). \emph{MatchIt: Getting started}. \url{https://kosukeimai.github.io/MatchIt/articles/MatchIt.html}

\leavevmode\vadjust pre{\hypertarget{ref-R-cobalt}{}}%
Greifer, N. (2022b). \emph{Cobalt: Covariate balance tables and plots}. \url{https://CRAN.R-project.org/package=cobalt}
