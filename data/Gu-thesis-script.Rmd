...
set.seed(1)
fig_cog <- 
  ggplot(d_migr, aes(x='Parental Migration Type', y=cog_dif, fill = `Parental Migration`)) + 
...
set.seed(1)
fig_ttl <- 
ggplot(d_migr, aes(x='Parental Migration Type', y=ttl_dif, fill = `Parental Migration`)) + 
    geom_jitter(color="black", size=0.4, alpha=0.9) +
    geom_boxplot(alpha=0.2)
```
...
table_cog <- models_cog %>% msummary(
  ...
  coef_rename =  c("migr" = "Explanator", "migr_mo_only" = "Explanator", "migr_mo" = "Explanator", "migr_fa" = "Explanator", "migr_fa_only" = "Explanator", "migr_both" = "Explanator", "cog3pl" = "W1 score"), 
  output = 'markdown')
table_cog
```
...
table_ttl <- models_ttl %>% msummary(
  ...
  fmt = 2,
  coef_rename = c("migr" = "Explanator", "migr_mo_only" = "Explanator", "migr_mo" = "Explanator", "migr_fa" = "Explanator", "migr_fa_only" = "Explanator", "migr_both" = "Explanator", "w1ttl_100" = "W1 score"), 
  gof_omit = 'R2 Pseudo|AIC|BIC|Log.Lik.|Std.Errors',
  output = 'markdown')
table_ttl
```
...
```{r}
d_cl1=d_cl1 %>% mutate(
  supervision.less = if_else(b2201 > w2a18 & b2202 > w2a19, 1, 0)
)
```
