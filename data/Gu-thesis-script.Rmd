...
fig_msmd_any <- summary(m.out) %>% plot(xlim = c(0, 0.55), position = 'right')
```
...
fig_msmd_mo_only <- summary(m.out_mo_only) %>% plot(xlim = c(0, 0.55), position = 'right')
```
...
fig_msmd_fa_only <- summary(m.out_fa_only) %>% plot(xlim = c(0, 0.55), position = 'right')
```
...
fig_msmd_both <- plot(summary(m.out_both), xlim = c(0, 0.55), position = 'right')
```
