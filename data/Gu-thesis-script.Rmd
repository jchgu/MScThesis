...
d_dpvar1 <- d_migr |>
  ...
  set_variable_labels(
    ...
    cog3pl ='Wave 1 score',
    w2cog3pl = 'Wave 2 score',
    w1ttl_100='Wave 1 score',
    w2ttl_100 = 'Wave 2 score',
    cog_dif = 'Cognitive test score difference',
    ttl_dif = 'Academic exam score difference'
  )
```
...
```{r}
d_ctvar_cnt <- d_migr |>
  select(migr, child.age, child.health.self.rated, child.educational.aspiration, 
  parent.educational.level, parent.expectation.on.child, 
  home.extracurricular.book, home.economic.resource)
```
...
d_ctvar <- d_ctvar |> 
  add_value_labels(
    parent.educational.level = c(
     ...
     'University' = 5,
     'Postgraduate' = 6),
    child.educational.aspiration = c(
...
tab_ctvar_dit[tab_ctvar_dit == 3452|tab_ctvar_dit == 636] <- ''
```
...
set.seed(1)
fig_ttl <-  d_smr |>
  ggplot(aes(x=`Parental Migration`, y=ttl_dif, fill=`Parental Migration`)) + 
    geom_violin()+
    xlab('Parental Migration') +
    theme(legend.position="none") +
...
fig_cog_by_migration_type <- d_smr |>
  ggplot(aes(x=`Parental Migration Type`, y=cog_dif)) + 
    geom_violin()+
...
fig_ttl_by_migration_type <- d_smr |>
  ggplot(aes(x=`Parental Migration Type`, y=ttl_dif)) + 
    geom_violin()+
    xlab('Parental Migration Type') +
    theme(legend.position="none") +
    ylab('Academic Exam Score Difference') +
...
```{r}
models_cog <- list(
'Any Parent Migrated' = did_cog,
'Only Mother Migrated' = did_cog_m_only,
#'Mother Migrated' = #did_cog_m,
'Only Father Migrated' = did_cog_f_only,
#'Father Migrated' = #did_cog_f,
'Both Parents Migrated' = did_cog_both) 
```

```{r}
stars <- c('†' = .1, '*' = .05, '**' = .01, '***' = .001)
coef_rename <- c("migr" = "Migration", "migr_mo_only" = "Migration", "migr_mo" = "Migration", "migr_fa" = "Migration", "migr_fa_only" = "Migration", "migr_both" = "Migration", "cog3pl" = "W1 score", "w1ttl_100" = "W1 score")
...
note_unadj <- 'Control variables not included'
```
...
```{r}
models_ttl <- list(
'Any Parent Migrated' = did_ttl,
'Only Mother Migrated' = did_ttl_m_only,
#'Mother Migrated' = #did_ttl_m,
'Only Father Migrated' = did_ttl_f_only,
#'Father Migrated' = #did_ttl_f,
'Both Parents Migrated' = did_ttl_both) 
```
...
```{}
models_ttl_z <- list(
'Any Parent Migrated' = did_ttl_z,
'Only Mother Migrated' = did_ttl_z_m_only,
#'Mother Migrated' = did_ttl_z_m,
'Only Father Migrated' = did_ttl_z_f_only,
#'Father Migrated' = did_ttl_z_f,
'Both Parents Migrated' = did_ttl_z_both) 
table_ttl_z <- models_ttl_z |> msummary(stars = c('*' = .05, '**' = .01, '***' = .001), 
                              fmt = 2,
                              coef_rename =  c("migr" = "Migration", "migr_mo_only" = "Migration", "migr_mo" = "Migration", "migr_fa" = "Migration", "migr_fa_only" = "Migration", "migr_both" = "Migration", "w1ttl_dif" = "Baseline difference"), output = 'markdown')
table_ttl_z
```
...
```{}
models_ttl_std <- list(
'Any Parent Migrated' = did_ttl_std,
'Only Mother Migrated' = did_ttl_std_m_only,
#'Mother Migrated' = did_ttl_std_m,
'Only Father Migrated' = did_ttl_std_f_only,
#'Father Migrated' = did_ttl_std_f,
'Both Parents Migrated' = did_ttl_std_both) 
...
```{r}
models_adj_cog <- list(
'Any Parent Migrated' = did_adj_cog,
'Only Mother Migrated' = did_adj_cog_m_only,
#'Mother Migrated' = #did_adj_cog_m,
'Only Father Migrated' = did_adj_cog_f_only,
#'Father Migrated' = #did_adj_cog_f,
'Both Parents Migrated' = did_adj_cog_both) 
```
...
```{r}
models_adj_ttl <- list(
'Any Parent Migrated' = did_adj_ttl,
'Only Mother Migrated' = did_adj_ttl_m_only,
#'Mother Migrated' = #did_adj_ttl_m,
'Only Father Migrated' = did_adj_ttl_f_only,
#'Father Migrated' = #did_adj_ttl_f,
'Both Parents Migrated' = did_adj_ttl_both)
```
...
'Any Parent Migrated' = did_adj_ttl_z,
'Only Mother Migrated' = did_adj_ttl_z_m_only,
#'Mother Migrated' = did_adj_ttl_z_m,
'Only Father Migrated' = did_adj_ttl_z_f_only,
#'Father Migrated' = did_adj_ttl_z_f,
'Both Parents Migrated' = did_adj_ttl_z_both) 
table_adj_ttl_z <- models_adj_ttl_z |> msummary(stars = c('*' = .05, '**' = .01, '***' = .001), fmt = 2, coef_rename =  c("migr" = "Migration", "migr_mo_only" = "Migration", "migr_mo" = "Migration", "migr_fa" = "Migration", "migr_fa_only" = "Migration", "migr_both" = "Migration", "w1ttl_dif" = "Baseline difference"), output = 'markdown')
table_adj_ttl_z
```
...
'Any Parent Migrated' = did_adj_ttl_dm,
'Only Mother Migrated' = did_adj_ttl_dm_m_only,
#'Mother Migrated' = did_adj_ttl_dm_m,
'Only Father Migrated' = did_adj_ttl_dm_f_only,
#'Father Migrated' = did_adj_ttl_dm_f,
'Both Parents Migrated' = did_adj_ttl_dm_both) 
table_adj_ttl_dm <- models_adj_ttl_dm |> msummary(stars = c('*' = .05, '**' = .01, '***' = .001), fmt = 2, coef_rename =  c("migr" = "Migration", "migr_mo_only" = "Migration", "migr_mo" = "Migration", "migr_fa" = "Migration", "migr_fa_only" = "Migration", "migr_both" = "Migration", "w1ttl_dif" = "Baseline difference"), output = 'markdown')
table_adj_ttl_dm
```
...
```{r}
models_m_cog <- list(
'Any Parent Migrated' = didm_cog,
'Only Mother Migrated' = didm_cog_mo_only,
##'Mother Migrated' = #did_adj_cog_m,
'Only Father Migrated' = didm_cog_fa_only,
##'Father Migrated' = #did_adj_cog_f,
'Both Parents Migrated' = didm_cog_both) 
```
...
```{r}
models_m_ttl <- list(
'Any Parent Migrated' = didm_ttl,
'Only Mother Migrated' = didm_ttl_mo_only,
##'Mother Migrated' = #did_adj_ttl_m,
'Only Father Migrated' = didm_ttl_fa_only,
##'Father Migrated' = #did_adj_ttl_f,
'Both Parents Migrated' = didm_ttl_both) 
...
'Any Parent Migrated' = didm_adj_cog,
'Only Mother Migrated' = didm_adj_cog_mo_only,
##'Mother Migrated' = #did_adj_cog_m,
'Only Father Migrated' = didm_adj_cog_fa_only,
##'Father Migrated' = #did_adj_cog_f,
'Both Parents Migrated' = didm_adj_cog_both) 
...
'Any Parent Migrated' = didm_adj_ttl,
'Only Mother Migrated' = didm_adj_ttl_mo_only,
##'Mother Migrated' = #did_adj_ttl_m,
'Only Father Migrated' = didm_adj_ttl_fa_only,
##'Father Migrated' = #did_adj_ttl_f,
'Both Parents Migrated' = didm_adj_ttl_both) 
...
feols(cog_dif ~ migr*fin.better + cog3pl | clsids + w2clsids, data = d_cl1)  |>
  msummary(stars = c('†' = .1, '*' = .05, '**' = .01, '***' = .001),
           output = 'markdown')
feols(ttl_dif ~ migr_mo_only*fin.better + w1ttl_100 | clsids + w2clsids, data = d_cl1) |>
  msummary(stars = c('†' = .1, '*' = .05, '**' = .01, '***' = .001),
           output = 'markdown')
feols(cog_dif ~ migr_mo_only*fin.better + cog3pl | clsids + w2clsids, data = d_cl1)  |>
  msummary(stars = c('†' = .1, '*' = .05, '**' = .01, '***' = .001),
           output = 'markdown')
feols(ttl_dif ~ migr_fa_only*fin.better + w1ttl_100 | clsids + w2clsids, data = d_cl1) |>
  msummary(stars = c('†' = .1, '*' = .05, '**' = .01, '***' = .001),
           output = 'markdown')
feols(cog_dif ~ migr_fa_only*fin.better + cog3pl | clsids + w2clsids, data = d_cl1)  |>
  msummary(stars = c('†' = .1, '*' = .05, '**' = .01, '***' = .001),
           output = 'markdown')
feols(ttl_dif ~ migr_both*fin.better + w1ttl_100 | clsids + w2clsids, data = d_cl1) |>
  msummary(stars = c('†' = .1, '*' = .05, '**' = .01, '***' = .001),
           output = 'markdown')
feols(cog_dif ~ migr_both*fin.better + cog3pl | clsids + w2clsids, data = d_cl1)  |>
  msummary(stars = c('†' = .1, '*' = .05, '**' = .01, '***' = .001),
           output = 'markdown')
```
